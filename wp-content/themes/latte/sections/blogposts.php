						...
						<div data-sr="ease-in-out wait 0.25s" class="col-md-4 col-sm-6 col-xs-12 blog-item">
							<div class="item">
								<?php if ( has_post_thumbnail($post->ID) ): ?>
									<?php echo get_the_post_thumbnail($post->ID, 'latte-blogposts'); ?></a>
								<?php else: ?>
									<img src="<?php echo get_template_directory_uri().'/assets/images/287x230.png'; ?>"/></a>
								<?php endif; ?>
								<div class="item-meta">
									<h3 class="post-title"><a href="<?php esc_url( the_permalink() ); ?>"><?php the_title(); ?></a></h3>
									<h6 class="post-meta"><?php the_time( get_option( 'date_format' ) ); ?></h6>
									<?php the_excerpt(); ?>
								</div>
							</div>
						</div>
